...
public class ControleurAbonne {
	...
	private final String REST_URI = "http://tomcatservice:8080/service-abonnement-newsletter";
	private String nom;
	...
	public String controler() {
		...
		AbonneDTO envoi = new AbonneDTO(civilite, nom, prenom, courriel, service, "envoi");
